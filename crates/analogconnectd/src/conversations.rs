        ...
        self.store()
            ...
            .map(|row| {
                ...
                Ok(StoredConversation {
                    ...
                    latest_preview: row.latest_text,
                    latest_sender: row.latest_sender,
            ...
            ConversationRepository::InMemory(Arc::new(InMemoryConversationRepository::new(
                vec![
                    StoredConversation {
                        ...
                        latest_preview: "Synthetic preview A".to_owned(),
                        latest_sender: "synthetic-address-a".to_owned(),
                        latest_sent: false,
                        group_title: None,
                        is_ancs_group: false,
                    ...
                    StoredConversation {
                        ...
                        unread_count: 1,
                        latest_outgoing_state: None,
                        latest_preview: "Synthetic preview B".to_owned(),
                        latest_sender: "synthetic-address-b".to_owned(),
                        latest_sent: false,
                        group_title: None,
                        is_ancs_group: false,
                        identity_conflict: false,
